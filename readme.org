...
** Basic drums
#+begin_src ruby
sample :drum_roll, attack: 0.5, release: 0, sustain: 2.5
sleep 3
...
use_bpm 90
live_loop :drums do
  use_random_seed 2021
  16.times do
    tick
    sample :drum_bass_hard  if pattern "x-x-----x-x--x--"
    sample :drum_snare_hard if one_in 2
    sample :drum_cymbal_closed
    sleep 0.25
  end
end
...
- [[https://old.reddit.com/r/Drumkits/comments/kne8lz/good_lofi_drum_one_shots/][Drums]] ([[https://old.reddit.com/r/Drumkits/search?q=Lofi&restrict_sr=on][search Reddit]] for more)
...
# - [[https://in-thread.sonic-pi.net/t/lofi-house-my-first-code/6834][Lofi house]]
# - [[https://in-thread.sonic-pi.net/t/looking-for-a-lofi-tape-effect/3136][Lofi tape effect]]
